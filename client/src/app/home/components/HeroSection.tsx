    ...
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 py-12 lg:py-20 gap-10 lg:gap-16">
        ...
        >
          <motion.h1
            variants={item}
            className="text-4xl md:text-5xl lg:text-[3.25rem] font-bold leading-[1.15] text-[#BE4D00] tracking-tight"
          >
          ...
          <motion.p
            variants={item}
            className="mt-5 text-gray-500 text-base md:text-lg leading-relaxed max-w-md"
          >
