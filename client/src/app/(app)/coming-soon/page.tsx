...
function ComingSoonScreen() {
  ...
  const activeKey = searchParams.get("nav") ?? undefined;
  const activeChildKey = searchParams.get("child") ?? undefined;

  return (
    <AppShell activeKey={activeKey} activeChildKey={activeChildKey}>
      <div className="flex min-h-[60vh] w-full flex-col items-center justify-center gap-5 rounded-[15px] border border-gray-200 bg-white p-8 text-center">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="max-w-sm text-sm text-gray-500">
            We&rsquo;re still building this part of Biltlinx. Check back soon &mdash; in the meantime,
