...
export function AuthBrandPanel() {
  return (
    <div className="hidden h-full w-full flex-col items-center justify-between overflow-hidden rounded-[38px] bg-gradient-to-r from-brand-gradient-from to-brand-gradient-to px-8 py-10 lg:flex">
