      ...
      {Array.from({ length: LENGTH }).map((_, index) => (
        <Fragment key={index}>
          <input
            ...
            aria-invalid={error}
            className={cn(
              "h-12 min-w-0 flex-1 rounded-xl bg-surface-button text-center text-base text-ink focus:outline-none focus:ring-2 focus:ring-brand-900 dark:bg-night-800 dark:text-white",
