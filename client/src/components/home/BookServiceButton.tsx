 ...
 * right — self-contained so PostEngagementBar just drops it into its `cta`
 * slot without owning any modal state itself, the same shape as
 * PropertyEnquiryButton/VenueReservationButton — the bar itself doesn't
 * know or care which one it's holding. */
