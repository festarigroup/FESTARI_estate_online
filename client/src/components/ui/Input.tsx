  ...
  return (
    <div className="flex w-full flex-col gap-2">
      ...
      <input
        ...
        className={cn(
          "h-12 w-full rounded-[16px] border border-muted-300 px-3 text-sm text-ink placeholder:text-muted-400 focus:outline-none focus:ring-2 focus:ring-brand-900 lg:rounded-lg",
