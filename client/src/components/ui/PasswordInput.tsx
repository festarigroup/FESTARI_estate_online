    ...
    <div className="flex w-full flex-col gap-2">
      ...
      <div className="relative">
        <input
          ...
          className={cn(
            "h-12 w-full rounded-[20px] border border-muted-300 px-3 pr-11 text-sm text-ink placeholder:text-muted-400 focus:outline-none focus:ring-2 focus:ring-brand-900 lg:rounded-lg",
