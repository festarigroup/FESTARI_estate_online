...
const BARE_ROUTES = ["/home", "/property", "/hotel", "/services", "/pricing", "/login", "/signup", "/verify-otp", "/verify-otp/change-contact", "/forgot-password"];
...
const HOTEL_DETAIL_ROUTE = /^\/hotel\/[^/]+$/;
...
export default function AppShell({ children }: { children: ReactNode }) {
  ...
  if (
    ...
    HOTEL_DETAIL_ROUTE.test(pathname)
  ) {
    return <>{children}</>;
  }
