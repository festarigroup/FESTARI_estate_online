...
- **Payment Processing**: Secure payments via Paystack (supports monthly and yearly subscription intervals)
...
### Home Content
- `GET /api/v1/home/summary/` - Fetch homepage summary data including top featured properties, hotels, artisans, and authenticated user payments
